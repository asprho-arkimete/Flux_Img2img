...
def run_inference(
    ...
    # Apply strength to guidance_scale (strength affects how much the model follows the prompt)
    effective_guidance_scale = guidance_scale * strength
...
def main():
    ...
    parser.add_argument('--strength', type=float, default=1.0, help='Strength factor for guidance scale')
